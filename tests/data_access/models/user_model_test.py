...
def mock_check_password_hash(mocker):
    return mocker.patch.object(
        user_model, "check_password_hash"
    )
...
class TestUserPassword:
    ...
    def test_calls_generate_password_hash_on_given_password(self, user,
